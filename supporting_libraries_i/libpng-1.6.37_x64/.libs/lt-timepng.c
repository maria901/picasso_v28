...
/* ./.libs/lt-timepng.c - temporary wrapper executable for .libs/timepng.exe
   Generated by libtool (GNU libtool) 2.4.6

   The timepng program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/project picasso/supporting_libraries_i/libpng-1.6.37_x64/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:/AMANDA;AVA;KOCI;PEREIRA/nosso_trabalho/amanda_projects/project;picasso/supporting_libraries_i/libpng-1.6.37_x64/.libs;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/lib;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/bin;";
const char * TARGET_PROGRAM_NAME = "timepng.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# timepng - temporary wrapper script for .libs/timepng.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.6\n", f);
  fputs ("#\n", f);
  fputs ("# The timepng program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"timepng.exe:timepng:$LINENO: libtool wrapper (GNU libtool) 2.4.6\" 1>&", f);
  fputs ("2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"timepng.exe:timepng:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"timepng.exe:timepng:$LINENO: newargv[0]: $progdir/$program\" 1>&2\n", f);
  ...
  fputs ("ject:picasso/supporting_libraries_i/libpng-1.6.37_x64/.libs:/usr/local/lib:/usr", f);
  ...
  fputs ("oject picasso/supporting_libraries_i/libpng-1.6.37_x64/.libs:$PATH\"\n", f);
  fputs ("\n", f);

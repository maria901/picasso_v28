...
const char * LIB_PATH_VALUE   = "C:/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/project picasso/supporting_libraries_i/libpng-1.6.37/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:/AMANDA;AVA;KOCI;PEREIRA/nosso_trabalho/amanda_projects/project;picasso/supporting_libraries_i/libpng-1.6.37/.libs;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/lib;C:/cygwin64_amandaricardo_koci_10.2.0/usr/local/bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("ject:picasso/supporting_libraries_i/libpng-1.6.37/.libs:/usr/local/lib:/usr/loc", f);
  fputs ("al/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/AMANDA AVA KOCI PEREIRA/nosso_trabalho/amanda_projects/pr", f);
  fputs ("oject picasso/supporting_libraries_i/libpng-1.6.37/.libs:$PATH\"\n", f);
  fputs ("\n", f);
